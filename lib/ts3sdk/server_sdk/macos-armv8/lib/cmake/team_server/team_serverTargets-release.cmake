...
set_target_properties(teamspeak::server PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libteamspeak_sdk_server.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libteamspeak_sdk_server.dylib"
  )

list(APPEND _cmake_import_check_targets teamspeak::server )
list(APPEND _cmake_import_check_files_for_teamspeak::server "${_IMPORT_PREFIX}/lib/libteamspeak_sdk_server.dylib" )
