/*
 * This is the main header for the TeamSpeak Server SDK. All the functions that are used
 * to communicate with the TeamSpeak Server are here. Please view the documentation for
 ...
 * @param argc The number of arguments provided to the application in argv. Used to process command line arguments
 * @param argv The command line arguments provided to the application. These will be processed prior to server lib initialization.
 * @return An Error code from the @ref Ts3ErrorType enum indicating either success or the failure reason
*/
EXPORTDLL unsigned int ts3server_initServerLib(const struct ServerLibFunctions* functionPointers, int usedLogTypes, const char* logFileFolder, int argc, const char* const * argv);
