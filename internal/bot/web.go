...
func (s *WebServer) handleLogin(w http.ResponseWriter, r *http.Request) {
	...
	http.Redirect(w, r, dest, http.StatusSeeOther) // #nosec G710 - path validated above
}
...
func (s *WebServer) handleDenied(w http.ResponseWriter, _ *http.Request) {
	w.WriteHeader(http.StatusForbidden) // 🛡️ Sentinel: Return 403 Forbidden to prevent improper caching of access denied pages.
