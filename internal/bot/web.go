...
func (s *WebServer) Start(ctx context.Context, addr string) error {
	...
	mux.HandleFunc("/static/abyss_collections.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_collections.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_auto_descend.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_auto_descend.css", "text/css; charset=utf-8")
	})
	mux.HandleFunc("/static/abyss_mob_affixes.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_mob_affixes.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_critical_fumble.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_critical_fumble.css", "text/css; charset=utf-8")
	})
	mux.HandleFunc("/static/abyss_gear_damage.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_gear_damage.css", "text/css; charset=utf-8")
	})
	mux.HandleFunc("/static/abyss_sentimental.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_sentimental.css", "text/css; charset=utf-8")
	})
	mux.HandleFunc("/static/abyss_shield.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_shield.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_skill_priority.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_skill_priority.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_run_awareness.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_run_awareness.css", "text/css; charset=utf-8")
	})
	mux.HandleFunc("/static/abyss_loot_presentation.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_loot_presentation.css", "text/css; charset=utf-8")
	})
	mux.HandleFunc("/static/abyss_pity.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_pity.css", "text/css; charset=utf-8")
	})
	mux.HandleFunc("/static/gear_inventory_motion.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/gear_inventory_motion.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_set_pity.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_set_pity.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_mobile.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_mobile.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_wiki.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_wiki.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_polish.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_polish.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_core_interface.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_core_interface.css", "text/css; charset=utf-8")
	})
	mux.HandleFunc("/static/abyss_events.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_events.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_layout_readability.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_layout_readability.css", "text/css; charset=utf-8")
	})
	mux.HandleFunc("/static/abyss_feedback_juice.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_feedback_juice.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_command_palette.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_command_palette.css", "text/css; charset=utf-8")
	})
	...
	mux.HandleFunc("/static/abyss_enemy_forecast.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/abyss_enemy_forecast.css", "text/css; charset=utf-8")
	})
	...
	if s.bot.Cfg.EnableAbyss {
		...
		mux.HandleFunc("/api/abyss/social/pet/fusion", s.authAPI(s.handleAbyssPetFusion))
		mux.HandleFunc("/api/abyss/social/pet/activity", s.authAPI(s.handleAbyssPetActivity))
		mux.HandleFunc("/api/abyss/social/pet/cosmetic", s.authAPI(s.handleAbyssPetCosmetic))
		mux.HandleFunc("/api/abyss/social/pet/revive", s.authAPI(s.handleAbyssPetRevive))
		mux.HandleFunc("/api/abyss/social/pet/gift/create", s.authAPI(s.handleAbyssPetGiftCreate))
		mux.HandleFunc("/api/abyss/social/pet/gift/claim", s.authAPI(s.handleAbyssPetGiftClaim))
		...
		mux.HandleFunc("/api/abyss/social/friend", s.authAPI(s.handleAbyssFriend))
		mux.HandleFunc("/api/abyss/social/friend/cheer", s.authAPI(s.handleAbyssFriendCheer))
		mux.HandleFunc("/api/abyss/social/mentor", s.authAPI(s.handleAbyssMentor))
		mux.HandleFunc("/api/abyss/social/referral", s.authAPI(s.handleAbyssReferral))
		mux.HandleFunc("/api/abyss/social/trade", s.authAPI(s.handleAbyssConsumableTrade))
		mux.HandleFunc("/api/abyss/social/shoutbox", s.authAPI(s.handleAbyssShoutbox))
		mux.HandleFunc("/api/abyss/social/floor_message", s.authAPI(s.handleAbyssFloorMessage))
		mux.HandleFunc("/api/abyss/social/kudos", s.authAPI(s.handleAbyssKudos))
		mux.HandleFunc("/api/abyss/social/guild", s.authAPI(s.handleAbyssGuild))
		mux.HandleFunc("/api/abyss/social/tournament", s.authAPI(s.handleAbyssTournamentTeam))
		...
		mux.HandleFunc("/api/abyss/loot/sell_junk", s.authAPI(s.handleAbyssSellJunkLoot))
		...
		mux.HandleFunc("/api/abyss/coop/leave", s.authAPI(s.handleAbyssCoopLeave))
