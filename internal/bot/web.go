...
func (s *WebServer) Start(ctx context.Context, addr string) error {
	...
	mux.HandleFunc("/static/gear_provenance.css", func(w http.ResponseWriter, r *http.Request) {
		ServeAsset(w, r, "webassets/gear_provenance.css", "text/css; charset=utf-8")
	})
