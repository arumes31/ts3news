...
func (s Stats) Details() []StatDetail {
	return []StatDetail{
		...
		{"CRT", "CRT rating", "Critical chance = 50 × total rating / (total rating + 50) percent; each additional point has diminishing benefit.", s.CRT, true},
		{"DGE", "DGE rating", "Dodge chance = 25 × total rating / (total rating + 25) percent; each additional point has diminishing benefit.", s.DGE, true},
